...
function CollectionPage({ data }) {
    ...
    const { collectionId2 } = useParams();

    console.log("params", collectionId);
    console.log("params2", collectionId2);
    const perPage = 12;
        ...
        <div className="collectionPage">
            <div className="container">
                <h3 className="collectionPage__card-title">
                    {Object.keys(data).map((id, ind) => {
                        if (id == collectionId - 1)
                            return data[id].collectionTitle;
                    })}
                </h3>
                ...
                <div className="collectionPage__newProducts">
                    <h2 className="collectionPage__newProducts-title">
                        Новинки
                    </h2>
                    <NewProduct
