...
function ProductPage({ data }) {
    ...
    function addToFavorites() {
        if (favorites.length === 0) {
            ...
            if (favorites.includes(`${collectionId}, ${productId}`)) {
                favorites.splice(
                    favorites.indexOf(`${collectionId}, ${productId}`),
                    1
                );
                setAddFavorites(false);
            } else {
    ...
    function addToBasket() {
        ...
        if (color !== "") {
            if (basket.length === 0) {
                ...
                if (
                    basket.includes(
                        `${collectionId}, ${productId}, ${color}, 1`
                    )
                ) {
                    basket.splice(
                        basket.indexOf(
        ...
        <div className="productPage">
            <div className="container">
                                ...
                                return data[id].collectionProducts.map(
                                    (item, index) => {
                                        if (index == productId - 1) {
                                            if (
                                                typeof item.productImg !==
                                                "string"
                                            ) {
                                                return item.productImg.map(
                                                    (img) => {
                                                        return (
                                                            <img
                ...
                <div className="productPage__newProduct">
                    <h2 className="productPage__newProduct-title">
                        Похожие товары
                    </h2>
                    <RelatedProducts
